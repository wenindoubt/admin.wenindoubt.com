...
## [1.0.0](https://github.com/wenindoubt/admin.wenindoubt.com/compare/admin.wenindoubt.com-v0.1.0...admin.wenindoubt.com-v1.0.0) (2026-04-06)
...
* add secure public ingest API for company/contact creation ([17c897b](https://github.com/wenindoubt/admin.wenindoubt.com/commit/17c897bdd4bb0d11b2499a18d02701d46c119f76))
...
* **db:** add prod migration pipeline, harden RLS, consolidate migrations ([12eca45](https://github.com/wenindoubt/admin.wenindoubt.com/commit/12eca4574d74acc4316fb2863d0459fc76cb1004))
...
* **ingest:** add note upsert support to ingest API ([1854588](https://github.com/wenindoubt/admin.wenindoubt.com/commit/185458892137d07fa29c371c7707a50abb90469a))
...
* multi-contact deals, rich text editor, phone formatting ([689fd6c](https://github.com/wenindoubt/admin.wenindoubt.com/commit/689fd6cf5ab39ee6430130ff9354f53d8dcca03a))
...
* **scout:** rename ingest to scout ([5bbac1c](https://github.com/wenindoubt/admin.wenindoubt.com/commit/5bbac1c26b1c3ae8df30d1a9415fa86981327757))
...
* **talent:** add talent management module ([52fc32d](https://github.com/wenindoubt/admin.wenindoubt.com/commit/52fc32d4f574580d1c3514601ffcc7337073ecd4))
* **talent:** revamp suggested panel + fix deal analysis flash ([67666f3](https://github.com/wenindoubt/admin.wenindoubt.com/commit/67666f3010946ffb53c71238ad174206d19be3be))
...
* CI failures — lazy Supabase init, hooks ordering, lint cleanup ([438f825](https://github.com/wenindoubt/admin.wenindoubt.com/commit/438f825c554d9bb2019e4cef3b48a7b24105ae88))
...
* E2E test data cleanup + stop mutating seed data ([cf2b7f7](https://github.com/wenindoubt/admin.wenindoubt.com/commit/cf2b7f72852d1b58dd0e3081daff6bbd33e58ac9))
...
* **ingest:** resolve contact deduplication on email add/change ([1589feb](https://github.com/wenindoubt/admin.wenindoubt.com/commit/1589febd3271f15acab3bc00b81dc2b872de6d0a))
...
* Supabase singleton HMR guard + docs accuracy sweep ([caf2751](https://github.com/wenindoubt/admin.wenindoubt.com/commit/caf275122bd979f9eddd0d68f7cf58194687806a))
